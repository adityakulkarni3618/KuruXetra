...
export default function CaptainDashboard() {
  ...
  return (
    <div>
      <h1 className="font-display text-3xl font-bold mb-1 text-white">{mySport.name} &mdash; Team Management</h1>
      <p className="text-white/50 text-sm mb-8">Select a management dashboard page to control your team settings, rosters, and practice logs.</p>
